...
// Calculate experience from 2021-01 (January 2021) to current date
const calculateExperience = (): string => {
  const startDate = new Date(2021, 0); // January 2021 (month is 0-indexed)
  const now = new Date();
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            <div className="relative w-full h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              <ImageWithFallback
                src="https://media.licdn.com/dms/image/v2/D5603AQEhebwWIaXzCg/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1708334015102?e=1759363200&v=beta&t=ctHK26gQdUnrEuA6Yh1XnIXukCXcR1jr9sJxCPjenOs"
                alt="Sakshi Tantak - Host of tantalks"
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h2 className="text-3xl md:text-4xl font-bold text-foreground">
                Meet <span className="text-primary">Sakshi Tantak</span>
              </h2>
              <p className="text-lg text-muted-foreground">
                The curious mind behind tantalks
              </p>
            </div>

            <div className="prose prose-lg max-w-none">
              <p className="text-foreground">
                Sakshi has been working as a data scientist for {experience} years now, bringing a unique blend of 
                technical expertise and philosophical curiosity to the world of AI and technology.
              </p>
            ...
            <div className="space-y-4">
              <p className="text-foreground">
                Through tantalks, Sakshi aims to present her thoughts and opinions alongside notable 
