...
export default function App() {
  const [currentView, setCurrentView] = useState<'home' | 'episodes' | 'blog' | 'blogPost'>('home');
  ...
  useEffect(() => {
    const checkAdminAccess = () => {
      ...
      const token = localStorage.getItem('tantalks_access_token');
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Loading tantalks...</p>
        </div>
      </div>
    );
  }
      ...
      default:
        return (
          <>
            ...
            <Episodes episodes={episodes} onViewAll={handleViewAllEpisodes} />
            <About />
            <Blog posts={blogPosts} onViewAll={handleViewAllBlog} onPostClick={handleBlogPostClick} />
          </>
        );
    }
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {currentView === 'home' && <Footer onNavigate={handleBackToHome} />}
